...
so currently this works both ways windows <-> linux but sometimes it might stops and not respond to the query right away, need to find a better way to handle the reponse, mdns is not very reliable ...
